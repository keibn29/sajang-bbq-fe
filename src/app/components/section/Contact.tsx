const Contact = () => {
  return (
    <div className="w-[1800px] mx-auto mt-[80px] relative">
      <iframe
      ...
      />
      <div className="absolute top-[10%] right-0 flex flex-col justify-center gap-[10px] h-[250px] w-[525px] bg-[#cb1411] text-white text-center">
